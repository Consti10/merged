// copy paste from https://github.com/raspberrypi/linux/blob/rpi-5.4.y/drivers/media/i2c/imx477.c
// to have a "good" reference driver for comparisons
