...
/* default connection interval min for direct connection */
#ifndef BTM_BLE_CONN_INT_MIN_DEF_DIRECT
#define BTM_BLE_CONN_INT_MIN_DEF_DIRECT     24      /* recommended min: 30ms  = 24 * 1.25 */
#endif
/* default connection interval max for direct connection */
#ifndef BTM_BLE_CONN_INT_MAX_DEF_DIRECT
#define BTM_BLE_CONN_INT_MAX_DEF_DIRECT     40      /* recommended max: 50 ms = 40 * 1.25 */
#endif
...
#define BTM_BLE_AD_TYPE_MESH_PB_ADV      0x29 /**< PB-ADV */
#define BTM_BLE_AD_TYPE_MESH_MSG         0x2A /**< Mesh Message */
#define BTM_BLE_AD_TYPE_MESH_BEACON      0x2B /**< Mesh Beacon */
...
**
** Parameters:      num_elem: number of scan response element.
**                  p_elem: scan response data triplet elements.
**
** Returns          void
**
*******************************************************************************/
tBTM_STATUS BTM_BleWriteRawScanRsp(UINT8 num_elem, tBTM_BLE_ADV_ELEM *p_elem);
