...
#define BSA_ERROR_CLI_UNEXPECTED_EVENT      117 /* Client received unexpected event */
#define BSA_ERROR_CLI_GKI_MBOX_ERROR        118 /* GKI_read_mbox returns NULL */
#define BSA_ERROR_CLI_TIMEOUT               119 /* Client timeout occurred */
#define BSA_ERROR_CLI_BAD_EVENT             120 /* Client bad event received */
...
#define BSA_ERROR_SRV_SEC_NOT_ALLOWED       303 /* Command not allowed */
...
#define BSA_ERROR_SRV_AVK_NOT_STREAMING           806    /* AVK not receiving a stream */

/* Insert new AV errors here and don't forget to update the following line (offset) */
#define BSA_ERROR_SRV_AVK_OFFSET            BSA_ERROR_SRV_AVK_NOT_STREAMING
...
#define BSA_ERROR_SRV_AVK_BAD_PARAM     (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL_CAC_BAD_PARAM)     /* bad parameter */
#define BSA_ERROR_SRV_AVK_BAD_REQUEST   (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL_CAC_BAD_REQUEST)   /* bad request */
#define BSA_ERROR_SRV_AVK_INTERNAL      (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL_CAC_INTERNAL)      /* internal error */
#if defined(CAC_OPEN_EVENT_STATUS_CHANGE) && (CAC_OPEN_EVENT_STATUS_CHANGE == TRUE)
#define BSA_ERROR_SRV_AVK_UNAVAILABLE    (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL_CAC_UNAVAILABLE)
#endif
#endif
 ...
 * MESH Errors
 */
#define BSA_ERROR_MESH_FIRST         2100                       /* Offset for BTA/BSA error conversion */
#define BSA_ERROR_MESH_FAIL          (1 + BSA_ERROR_MESH_FIRST) /* Generic Failure */
#define BSA_ERROR_MESH_NO_PERMISSION (2 + BSA_ERROR_MESH_FIRST) /* Permision denied */
#define BSA_ERROR_MESH_NOT_FOUND     (3 + BSA_ERROR_MESH_FIRST) /* File not found */
#define BSA_ERROR_MESH_FULL          (4 + BSA_ERROR_MESH_FIRST) /* File too big or FS full */
#define BSA_ERROR_MESH_BUSY          (5 + BSA_ERROR_MESH_FIRST) /* Another operating ongoing */
#define BSA_ERROR_MESH_ABORTED       (6 + BSA_ERROR_MESH_FIRST) /* Operation was aborted */
