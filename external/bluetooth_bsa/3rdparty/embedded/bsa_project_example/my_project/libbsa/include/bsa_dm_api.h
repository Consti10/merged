...
#define BSA_DM_CHIP_ID_20704A1       0x66    /* 20704A1 */
#define BSA_DM_CHIP_ID_20704A2       0x7E    /* 20704A2 */
...
{
    BD_ADDR bd_addr;            /* BdAddr of the peer device */
    UINT16 min_conn_int;        /* minimum connection interval */
    UINT16 max_conn_int;        /* maximum connection interval */
    UINT16 slave_latency;       /* slave latency */
    UINT16 supervision_tout;    /* supervision timeout value */
    BOOLEAN preference;         /* if this is true, preferred value will be changed
                                   if this is false, conn param will be changed now  */
