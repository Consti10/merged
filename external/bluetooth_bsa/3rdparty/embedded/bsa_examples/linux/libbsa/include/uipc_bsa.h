...
#define UIPC_CH_ID_MCE_RX_FIRST (UIPC_CH_ID_PBS + 1)
#define UIPC_CH_ID_MCE_RX_LAST  (UIPC_CH_ID_MCE_RX_FIRST + UIPC_CH_ID_MCE_NB - 1)

#define UIPC_CH_ID_MCE_TX_FIRST (UIPC_CH_ID_MCE_RX_LAST + 1)
#define UIPC_CH_ID_MCE_TX_LAST  (UIPC_CH_ID_MCE_TX_FIRST + UIPC_CH_ID_MCE_NB - 1)

#define UIPC_CH_ID_SAC (UIPC_CH_ID_MCE_TX_LAST + 1)     /* SAC */
...
/*define here Ch IDs used by MESH*/
#ifndef UIPC_CH_ID_MESH_NB
#define UIPC_CH_ID_MESH_NB   2
#endif

/* MESH */
#define UIPC_CH_ID_MESH_FIRST    (UIPC_CH_ID_PAN_LAST + 1)
#define UIPC_CH_ID_MESH_LAST     (UIPC_CH_ID_MESH_FIRST + UIPC_CH_ID_MESH_NB - 1)


#define UIPC_FIRST_BSA_CH_ID UIPC_CH_ID_CTL
#define UIPC_LAST_BSA_CH_ID UIPC_CH_ID_MESH_LAST
