...
#endif  /* BTM_INQ_GET_REMOTE_NAME == TRUE || BLE_INCLUDED == TRUE */
...
#if (BTM_BR_SC_INCLUDED == TRUE) || (SMP_LE_SC_INCLUDED == TRUE) /* BSA_SPECIFIC */
...
#define BTM_LE_KEYPR_NOTIF_EVT  SMP_PEER_KEYPR_NOT_EVT  /* received from peer keypress notification */
...
#define BTM_LE_SC_PEER_SC_KNOWN_EVT SMP_SC_PEER_SC_KNOWN_EVT
#endif
...
#else
#define BTM_LE_COMPLT_EVT       SMP_COMPLT_EVT          /* SMP complete event */
#define BTM_LE_LAST_FROM_SMP    BTM_LE_COMPLT_EVT
#endif
...
typedef tSMP_SC_KEY_TYPE    tBTM_LE_SC_KEY_TYPE;
#endif  /* BLE_INCLUDED == TRUE && SMP_INCLUDED == TRUE && SMP_LE_SC_INCLUDED == TRUE */
...
typedef union
{
    ...
    UINT32              key_notif;  /* BTM_LE_KEY_NOTIF_EVT   */
                                    /* BTM_LE_NC_REQ_EVT */
                                    /* no callback data for BTM_LE_KEY_REQ_EVT & BTM_LE_OOB_REQ_EVT */
#if BLE_INCLUDED == TRUE && SMP_INCLUDED == TRUE
    tBTM_LE_COMPLT      complt;     /* BTM_LE_COMPLT_EVT      */
#if SMP_LE_SC_INCLUDED == TRUE
    tBTM_LE_SC_KEY_TYPE peer_keypr_notif;   /* BTM_LE_KEYPR_NOTIF_EVT */
#if SMP_LE_SC_OOB_INCLUDED == TRUE
...
**
*******************************************************************************/
BTM_API extern void BTM_SetOutService(BD_ADDR bd_addr, UINT8 service_id,
                                      UINT32 mx_chan_id);
