...
typedef uint32_t  wiced_utc_time_ms_t; /**< UTC Time in milliseconds   */
 ...
 * @return WICED_SUCCESS  on success
 */
wiced_result_t wiced_filesystem_file_tell ( wiced_file_t* file_handle, uint32_t* location );
 ...
 * @return WICED_SUCCESS  on success
 */
wiced_result_t wiced_filesystem_file_read ( wiced_file_t* file_handle, void* data, uint32_t bytes_to_read, uint32_t* returned_bytes_count );
 ...
 * @return WICED_SUCCESS  on success
 */
wiced_result_t wiced_filesystem_file_write( wiced_file_t* file_handle, const void* data, uint32_t bytes_to_write, uint32_t* written_bytes_count );
