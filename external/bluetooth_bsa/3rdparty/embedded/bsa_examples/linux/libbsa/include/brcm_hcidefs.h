...
#define HCI_BRCM_WRITE_RCV_ONLY_OPCODE      (0x002B | HCI_GRP_VENDOR_SPECIFIC)
...
#endif
#define HCI_BLE_APCF_OCF                    (0x0157 | HCI_GRP_VENDOR_SPECIFIC)
...
#define HCI_CY_SET_BTCX_LE_SCAN             (0x01B1 | HCI_GRP_VENDOR_SPECIFIC)
#define HCI_CY_SET_BTCX_LE_SCAN_PARAM_DEF        "\x30\x00\x64\x03"
#define HCI_CY_SET_BTCX_LE_SCAN_PARAM_HIGH       "\x30\x00\x64\x01"
