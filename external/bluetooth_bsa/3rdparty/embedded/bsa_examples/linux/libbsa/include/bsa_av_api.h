...
#define BSA_AV_FEAT_COVER_ART   BTA_AV_FEAT_COVER_ART /* streaming media content protection */
...
typedef tBTA_AV_CA_IMG_PROPERTIES tBSA_AV_CA_IMG_PROPERTIES;
...
{
    tBSA_AV_CAS_RSP rsp;
    tBSA_AV_CA_IMG_PROPERTIES *p_prop;
} tBSA_AV_CAS_GET_IMAGE_PROP_RSP;

typedef struct
{
    tBSA_AV_CAS_RSP rsp;
    UINT8 *p_name;
} tBSA_AV_CAS_GET_IMAGE_RSP;

typedef tBSA_AV_CAS_GET_IMAGE_RSP tBSA_AV_CAS_GET_THUMB_RSP;
#endif
...
/*******************************************************************************
 **
 ** Function         BSA_AvCasEnableInit
 **
 ** Description      Init structure tBSA_AV_CAS_ENABLE
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasEnableInit(tBSA_AV_CAS_ENABLE *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasEnable
 **
 ** Description      Called to enable the Cover Art Server
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasEnable(tBSA_AV_CAS_ENABLE *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasDisableInit
 **
 ** Description      Init structure tBSA_AV_CAS_DISABLE
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasDisableInit(tBSA_AV_CAS_DISABLE *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasDisable
 **
 ** Description      Called to disable the Cover Art Server
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasDisable(tBSA_AV_CAS_DISABLE *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasGetImgPropRspInit
 **
 ** Description      Init structure tBSA_AV_CAS_GET_IMAGE_PROP_RSP
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasGetImgPropRspInit(tBSA_AV_CAS_GET_IMAGE_PROP_RSP *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasGetImgPropRsp
 **
 ** Description      Cover Art Get Image Properties response
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasGetImgPropRsp(tBSA_AV_CAS_GET_IMAGE_PROP_RSP *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasGetImgRspInit
 **
 ** Description      Init structure tBSA_AV_CAS_GET_IMAGE_RSP
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasGetImgRspInit(tBSA_AV_CAS_GET_IMAGE_RSP *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasGetImgRsp
 **
 ** Description      Cover Art Get Image response
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasGetImgRsp(tBSA_AV_CAS_GET_IMAGE_RSP *p_req);

/*******************************************************************************
 **
 ** Function         BSA_AvCasGetThumbRspInit
 **
 ** Description      Init structure tBSA_AV_CAS_GET_IMAGE_RSP
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasGetThumbRspInit(tBSA_AV_CAS_GET_THUMB_RSP *p_req);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvCasGetThumbRsp(tBSA_AV_CAS_GET_THUMB_RSP *p_req);
