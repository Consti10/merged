...
// prefixed with X to get rid of the stupid compiler :)

#define START_CODE 0x000001 ///< start_code_prefix_one_3bytes

static RK_S32 Xget_next_nal(RK_U8 *buf, RK_S32 *length)
{
    RK_S32 i, consumed = 0;
    RK_S32 len = *length;
    RK_U8 *tmp_buf = buf;
...
MPP_RET Xh264e_vepu_stream_amend_init(HalH264eVepuStreamAmend *ctx)
{
...
MPP_RET Xh264e_vepu_stream_amend_deinit(HalH264eVepuStreamAmend *ctx)
{
...
MPP_RET Xh264e_vepu_stream_amend_config(HalH264eVepuStreamAmend *ctx,
...
MPP_RET Xh264e_vepu_stream_amend_proc(HalH264eVepuStreamAmend *ctx)
{
